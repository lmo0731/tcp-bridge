...
public class BridgeClient implements Runnable {
        ...
        try {
            ...
            while (true) {
                ...
                dataHandler.setListener(new TcpDataListener() {
                    ...
                    @Override
                    public void onStart(int id) throws Throwable {
                    ...
                    @Override
                    public void onEnd(int id) throws Throwable {
    ...
    void open(final int srcId, final int srcPort, final String host, final int port, String password) throws IOException, BridgeDataException {
        ...
        dataHandler.setListener(new TcpDataListener() {
            ...
            @Override
            public void onWrite(int id, byte[] b) throws Throwable {
    ...
    public void start() {
        ...
        if (isConnected()) {
            ...
            logger.info("already connected to bridge server");
        }
    }

    public void stop() {
        logger.info("closing app connection");
        try {
            ss.close();
        } catch (Throwable ex) {
        }
